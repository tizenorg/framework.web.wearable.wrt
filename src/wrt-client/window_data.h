...
{
  public:
    typedef std::function<void(void)> ResumeCallback;
    typedef std::function<void(void)> SuspendCallback;
    struct MiniControlCallback {
        ResumeCallback resumeCallback;
        SuspendCallback suspendCallback;
    };
    typedef std::shared_ptr<MiniControlCallback> MiniControlCallbackPtr;
    ...
    void smartCallbackDel(
        ...
        const char* event,
        Evas_Smart_Cb callback);
    void setMiniControlCallback(const MiniControlCallbackPtr& callback);
  ...
  private:
    ...
    MiniControlCallbackPtr m_miniControlCallback;
    ...
    static Eina_Bool naviframeItemPopCallback(void *data,
                                          Elm_Object_Item *it);
    static void miniControlCallback(Ecore_Evas* ee, int domain, int id, void* data, int size);
 };
